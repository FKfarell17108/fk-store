...
<div id="box">
  ...
  <table class="news">
    ...
    foreach ($data as $value): ?>
      <tr>
        ...
        <td style="white-space: nowrap;"><?php echo $value['id_message'] ?></td>
        <td style="white-space: nowrap;"><?php echo $value['name'] ?></td>
        <td style="white-space: nowrap;"><?php echo $value['email'] ?></td>
        <td><?php echo $value['message'] ?></td>
        <td style="white-space: nowrap;"><?php echo $value['created_at'] ?></td>
        <td>
  ...
  for ($i = 1; $i <= $jmlhal; $i++) {
    if ($i == $hal) {
      ...
      echo "<span><a href='?page=pesan&hal=$i'>$i</a></span>";
    }
  }
  if ($hal < $jmlhal) {
  }

                        ...
                        <ul class="nav">
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="admin/page/products.php">Produk Kami</a></li>
                                    <li><a href="admin/page/user/keranjang.php">Keranjang</a></li>
                                    <li><a href="admin/page/user/belanja.php">Pesanan</a></li>
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="page/comments/index.php">Komentar</a></li>
                                    <li><a href="page/signout.php">Sign Out</a></li>
                                </ul>
                            </li>
                            <li class="scroll-to-section"><a href="#explore">Eksplorasi</a></li>
                        </ul>
                    ...
                    <div class="container h-full">
                        <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                            ...
                            <div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1600">
                                <a href="#old-money" class="tombol-slider">
                                    Look Now!
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="container h-full">
                        <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                            ...
                            <div class="layer-slick1 animated visible-false" data-appear="slideInUp" data-delay="1600">
                                <a href="#korean" class="tombol-slider">
                                    Look Now!
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="container h-full">
                        <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                            ...
                            <div class="layer-slick1 animated visible-false" data-appear="rotateIn" data-delay="1600">
                                <a href="#stone-island" class="tombol-slider">
                                    Look Now!
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="left-content">
                        <div class="thumb">
                            <div class="inner-content">
                                <h4>Halo, Kami Adalah FKStore</h4>
                                <span>Online Casuals Store Terbaik Di Eropa &amp; Asia Cabang Indonesia</span>
                                <div class="main-border-button">
                                    <a href="admin/page/products.php">Membeli Sekarang!</a>
                                    <!-- <a href="page/comments/index.php">Membeli Sekarang!</a> -->
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <a href="admin/page/kategori/old_money.php">
                            ...
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <a href="admin/page/kategori/korean.php">
                            ...
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <a href="admin/page/kategori/stone_island.php">
                            ...
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <a href="admin/page/kategori/aksesoris.php">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-heading">
                        ...
                        <div class="see-all">
                            <a href="admin/page/kategori/korean.php" class="main-border-button">Lihat Semua</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-heading">
                        ...
                        <span>Kualitas premium inilah yang membedakan FKStore dengan Store lainnya.</span>
                        <div class="see-all">
                            <a href="admin/page/kategori/old_money.php" class="main-border-button">Lihat Semua</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-heading">
                        ...
                        <span>Kualitas premium inilah yang membedakan FKStore dengan Store lainnya.</span>
                        <div class="see-all">
                            <a href="admin/page/kategori/stone_island.php" class="main-border-button">Lihat Semua</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="left-content">
                        ...
                        <span>Jelajahi koleksi produk terbaru dan terbatas milik kami dan temukan style berpakaian
                            casual yang sesuai dengan Anda.</span>
                        <div class="quote">
                            <i class="fa fa-quote-left"></i>
                            <p>Kualitas premium inilah yang membedakan FKStore dengan Store lainnya.</p>
                        </div>
                        <p>Jelajahi koleksi sepatu terbaru dan terbatas milik kami dan temukan jenis sepatu sesuai style
                            berpakaian casual Anda. Jelajahi keindahan produk kami dan temukan inspirasi yang tak
                            terbatas tentang style berpakaian casual Anda.</p>
                        <p>Kami telah mengeluarkan produk terbaru dan terbatas kami, yaitu Adidas Superstar dan Nike
                            Court Air dan berbagai macam jenis sepatu yang dapat Anda pilih sesuai style berpakaian
                            casual Anda dengan mengklik Temukan Lebih Banyak.</p>
                        <div class="main-border-button">
                            <a href="admin/page/kategori/sepatu.php">Temukan Lebih Banyak</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="right-content">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="leather">
                                    ...
                                    <span>Koleksi Terbatas</span>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="first-image">
                                    <img src="assets/images/explore-image-adidas-01.jpeg" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="second-image">
                                    <img src="assets/images/explore-image-nike-02.jpeg" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="types">
                                    <h4>Nike Court Air</h4>
                        ...
                        <style>
                            ...
                            .types:hover {
                                ...
                                /* Mengubah background saat di-hover */
                            }
                        </style>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3">
                    ...
                    <ul>
                        <li><a href="admin/page/kategori/korean.php">Korean Casuals</a></li>
                        <li><a href="admin/page/kategori/old_money.php">Old Money Casual</a></li>
                        <li><a href="admin/page/kategori/stone_island.php">Stone Island</a></li>
                    </ul>
                </div>
                <div class="col-lg-3">
